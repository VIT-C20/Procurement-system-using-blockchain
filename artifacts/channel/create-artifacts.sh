...
echo "#######    Generating anchor peer update for GovMSP  ##########"
./bin/configtxgen -profile BidChannel -configPath . -outputAnchorPeersUpdate ./GovMSPanchors_bidChhanel.tx -channelID $CHANNEL_NAME2 -asOrg GovMSP

echo "#######    Generating anchor peer update for BidderMSP  ##########"
./bin/configtxgen -profile BidChannel -configPath . -outputAnchorPeersUpdate ./BidderMSPanchors_bidChhanel.tx -channelID $CHANNEL_NAME2 -asOrg BidderMSP